...
def crawl_team_data():
    ...
    bangdan = ['defen', 'lanban', 'zhugong', 'qiangduan', 'gaima', 'shiwu']
    bangdan1 = ['nbaPlayerSeasonPointsRank', 'nbaPlayerSeasonReboundsRank', 'nbaPlayerSeasonAssistsRank',
                'nbaPlayerSeasonStealsRank', 'nbaPlayerSeasonBlocksRank', 'nbaPlayerSeasonTurnoversRank']
    ct = ['pointsPG', 'reboundsPG', 'assistsPG', 'stealsPG', 'blocksPG', 'turnoversPG']
    bangdan2 = ['nbaTeamSeasonPointsTop5', 'nbaTeamSeasonReboundTop5', 'nbaTeamSeasonAssitsTop5',
                'nbaTeamSeasonStealTop5', 'nbaTeamSeasonBlockTop5', 'nbaTeamSeasonTurnoverTop5']
    categorys = ['场均得分', '场均篮板', '场均助攻', '场均抢断', '场均盖帽', '场均失误']
    result1 = {}
    for i in range(0, 6):
        data = {}
        playerList = []
        ...
        # result1[bangdan1[i]] = data 优化
        result1[bangdan[i]] = data
    # print(result1)
    ...
    for i in range(0, 6):
        ...
        # result2[bangdan2[i]] = data 优化
        result2[bangdan[i]] = data
    # print(result2)
